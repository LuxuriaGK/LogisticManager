...
Public Class frmMain
    ...
    Private Sub InsertLogistic()
        ...
        New LogisticSupport("1-1", 0, 15),
        New LogisticSupport("1-2", 0, 30),
        New LogisticSupport("1-3", 1, 0),
        New LogisticSupport("1-4", 2, 0),
        New LogisticSupport("2-1", 0, 40),
        New LogisticSupport("2-2", 1, 0),
        New LogisticSupport("2-3", 4, 0),
        New LogisticSupport("2-4", 6, 0),
        New LogisticSupport("3-1", 0, 20),
        New LogisticSupport("3-2", 0, 45),
        New LogisticSupport("3-3", 1, 30),
        New LogisticSupport("3-4", 5, 0),
        New LogisticSupport("4-1", 1, 0),
        New LogisticSupport("4-2", 2, 0),
        New LogisticSupport("4-3", 6, 0),
        New LogisticSupport("4-4", 8, 0),
        New LogisticSupport("5-1", 0, 30),
        New LogisticSupport("5-2", 2, 30),
        New LogisticSupport("5-3", 4, 0),
        New LogisticSupport("5-4", 7, 0),
        New LogisticSupport("6-1", 2, 0),
        New LogisticSupport("6-2", 3, 0),
        New LogisticSupport("6-3", 5, 0),
        New LogisticSupport("6-4", 12, 0),
        New LogisticSupport("7-1", 2, 30),
        New LogisticSupport("7-2", 4, 0),
        New LogisticSupport("7-3", 5, 30),
        New LogisticSupport("7-4", 8, 0),
        New LogisticSupport("8-1", 1, 0),
        New LogisticSupport("8-2", 3, 0),
        New LogisticSupport("8-3", 6, 0),
        New LogisticSupport("8-4", 9, 0),
        New LogisticSupport("9-1", 0, 30),
        New LogisticSupport("9-2", 1, 30),
        New LogisticSupport("9-3", 4, 30),
        New LogisticSupport("9-4", 7, 0),
        New LogisticSupport("10-1", 0, 40),
        New LogisticSupport("10-2", 1, 40),
        New LogisticSupport("10-3", 5, 20),
        New LogisticSupport("10-4", 10, 0),
        New LogisticSupport("11-1", 4, 0),
        New LogisticSupport("11-2", 4, 0),
        New LogisticSupport("11-3", 8, 0),
        New LogisticSupport("11-4", 10, 0)}
    End Sub
